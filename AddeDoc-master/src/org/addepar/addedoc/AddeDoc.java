...
public class AddeDoc {
    ...
    public static void RunAddeDoc(String[] args, IProgressMonitor monitor) {
        ...
        if (monitor != null) {
            ...
            monitor.beginTask("AddeDoc - documenting your Apex Class files.", (files.size() / 2) * 3 + 2);
        }
        ...
        // we are done!
        System.out.println("AddeDoc has completed!");
    }

    private static void printHelp() {
        System.out.println("AddeDoc - a tool for generating documentation from Salesforce Apex code class files.\n");
        System.out.println("    Invalid Arguments detected.  The correct syntax is:\n");
        System.out.println("AddeDoc -s <source_directory> [-t <target_directory>] [-g <source_url>] [-h <homefile>] [-a <authorfile>] [-p <scope>]\n");
